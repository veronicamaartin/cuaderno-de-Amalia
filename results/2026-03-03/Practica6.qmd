...
## Ejercicio 1
**Construye las URLs necesarias para determinar el número de registros del resto de tipos: *protein*, *structure*, *set*, y *proteome*. Fíjate en las posiblesfuentes de cada tipo de datos, e intenta guardar la información en variables de tu sesión de R.**
...
```
No nos deja instalar el kableExtra, como ya pasó el otro dia, sustituimos el kableExtra por el paquete knitr y borramos el porcentaje
```{r}
library('knitr')
...
https://www.ebi.ac.uk/interpro/api/protein
Primero creamos dos objetos con las dos urls:
```{r}
