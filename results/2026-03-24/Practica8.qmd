...
Hay que tener instalado el paquete Biostrings, primero hay que comprobar que tenemos instalado el paquete BiocManager install.packages('BiocManager') BiocManager::install('Biostrings') 
...
Evalue es el numero esperado de alineamientos con una puntuacion. Inclusion_ethresh define el valor umbral de evalor. 
Para hacer la busqueda mas sensible se repite el psiblasta hasta llegar a la convergencia
